...
namespace cartasCREDITO
{
    class AdminPlural1
    {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                ...
                using (SQLiteTransaction tr = con.BeginTransaction())
                {
                    using (SQLiteCommand comando = new SQLiteCommand())
                    {
                        ...
                        comando.CommandText = string.Format("update plural1 set meses='{0}',anio='{1}',pie='{2}',asesor='{3}',cantidad='{4}',cantidadL='{5}',fecha='{6}' where id={7}",
        ...
        public static int registrar(Plural2 c)
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                ...
                using (SQLiteTransaction tr = con.BeginTransaction())
                {
                    ...
                    {
                        comando.Transaction = tr;
                        comando.CommandText = string.Format("insert into plural1 values('{0}','{1}','{2}','{3}','{4}','{5}','{6}','{7}','{8}')",
        ...
        public static int eliminar(string id)
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                ...
                using (SQLiteTransaction tr = con.BeginTransaction())
                {
                    ...
                    {
                        comando.Transaction = tr;
                        comando.CommandText = string.Format("delete from plural1 where id='{0}'", id);
                        res = comando.ExecuteNonQuery();
                        tr.Commit();
                    }
                }
        ...
        public static DataTable buscaPlural1()
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                using (SQLiteCommand comando = new SQLiteCommand())
                {
                    comando.CommandText = "select * from plural1";
        ...
        public static DataTable buscaDatosPlural1()
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                using (SQLiteCommand comando = new SQLiteCommand())
                {
                    comando.CommandText = "select * from datosPlural1";
                    comando.Connection = con;
                    con.Open();
                    SQLiteDataReader lector = comando.ExecuteReader();
                    while (lector.Read())
        ...
        public static int totalPlural1()
        {
            int total = 0;
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                using (SQLiteCommand comando = new SQLiteCommand())
                {
                    comando.CommandText = "select count(*) from plural1";
                    comando.Connection = con;
                    con.Open();
                    SQLiteDataReader lector = comando.ExecuteReader();
                    while (lector.Read())
        ...
        public static DataTable consulta(string nombre)
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                using (SQLiteCommand comando = new SQLiteCommand())
                {
                    comando.CommandText = string.Format("select * from datosPlural1 where nombre like '%{0}%' ", nombre);
                    comando.Connection = con;
                    con.Open();
                    SQLiteDataReader lector = comando.ExecuteReader();
                    while (lector.Read())
        ...
        public static DataTable consultaPorId(string id)
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                using (SQLiteCommand comando = new SQLiteCommand())
                {
                    comando.CommandText = string.Format("select * from datosPlural1 where id='{0}' ", id);
                    comando.Connection = con;
                    con.Open();
                    SQLiteDataReader lector = comando.ExecuteReader();
                    while (lector.Read())
        ...
        public static DataTable consulta2(string nombre)
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                using (SQLiteCommand comando = new SQLiteCommand())
                {
                    comando.CommandText = string.Format("select * from datosPlural11 where nombre like '%{0}%' ", nombre);
                    comando.Connection = con;
                    con.Open();
                    SQLiteDataReader lector = comando.ExecuteReader();
                    while (lector.Read())
