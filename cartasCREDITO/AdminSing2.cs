...
namespace cartasCREDITO
{
    class AdminSing2
    {
        ...
        public static int eliminar(string id)
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                ...
                using (SQLiteTransaction tr = con.BeginTransaction())
                {
                    ...
                    {
                        comando.Transaction = tr;
                        comando.CommandText = string.Format("delete from sing2 where id='{0}'",id);
                        res = comando.ExecuteNonQuery();
                        tr.Commit();
                    }
                }
        ...
        public static DataTable buscaSing2()
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                using (SQLiteCommand comando = new SQLiteCommand())
                {
                    comando.CommandText = "select * from sing2";
        ...
        public static DataTable buscaDatosSing2()
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                using (SQLiteCommand comando = new SQLiteCommand())
                {
                    comando.CommandText = "select * from datosSing2";
                    comando.Connection = con;
                    con.Open();
                    SQLiteDataReader lector = comando.ExecuteReader();
                    while (lector.Read())
        ...
        public static int totalSing2()
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                using (SQLiteCommand comando = new SQLiteCommand())
                {
                    comando.CommandText = "select count(*) from sing2";
                    comando.Connection = con;
                    con.Open();
                    SQLiteDataReader lector = comando.ExecuteReader();
                    while (lector.Read())
        ...
        public static DataTable consulta(string nombre)
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                using (SQLiteCommand comando = new SQLiteCommand())
                {
                    comando.CommandText = string.Format("select * from datosSing2 where nombre like '%{0}%' ", nombre);
                    comando.Connection = con;
                    con.Open();
                    SQLiteDataReader lector = comando.ExecuteReader();
                    while (lector.Read())
        ...
        public static DataTable consultaPorId(string id)
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                using (SQLiteCommand comando = new SQLiteCommand())
                {
                    comando.CommandText = string.Format("select * from datosSing2 where id='{0}' ",id);
                    comando.Connection = con;
                    con.Open();
                    SQLiteDataReader lector = comando.ExecuteReader();
                    while (lector.Read())
        ...
        public static DataTable consulta2(string nombre)
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(Datos.conexion))
            {
                using (SQLiteCommand comando = new SQLiteCommand())
                {
                    comando.CommandText = string.Format("select * from datosSing22 where nombre like '%{0}%' ", nombre);
                    comando.Connection = con;
                    con.Open();
                    SQLiteDataReader lector = comando.ExecuteReader();
                    while (lector.Read())
